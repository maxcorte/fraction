...
class TestFraction(unittest.TestCase):
    def test_initialization(self):
        ...
        self.assertEqual(fraction4.numerateur, -2)
        self.assertEqual(fraction4.denominateur, 3)
        fraction5 = Fraction(2, -3)
        self.assertEqual(fraction5.numerateur, -2)
        self.assertEqual(fraction5.denominateur, 3)
    ...
    def test_subtraction(self):
        ...
        fraction4 = Fraction(0, 7)
        result = fraction2 - fraction3
        result2 = fraction1 - fraction2
        result3 = fraction1 - fraction4
        result4 = fraction1 - fraction3
        self.assertEqual(result, Fraction(11, 4))
        self.assertEqual(result2, Fraction(-5, 4))
        self.assertEqual(result3, Fraction(-1, 2))
        self.assertEqual(result4, Fraction(3, 2))
    ...
    def test_power(self):
        ...
        self.assertEqual(result3, Fraction(0, 1))
        self.assertEqual(result4, Fraction(1, 1))
    ...
    def test_nombre_mixte(self):
        ...
        self.assertEqual(result2, "-1 + 1/2")
        self.assertEqual(fraction3.nombre_mixte(), "2 + 1/2")
        self.assertEqual(fraction4.nombre_mixte(), "0/1")
        self.assertEqual(fraction6.nombre_mixte(), "1/2")
        with self.assertRaises(ValueError):
    ...
    def test_unitary_fraction_check(self):
        ...
        self.assertEqual(fraction4.est_unitaire(), False)
        self.assertEqual(fraction5.est_unitaire(), False)
        self.assertEqual(fraction2.est_unitaire(), False)
        self.assertEqual(fraction3.est_unitaire(), False)
